...
<html>
	<head>
		<title>Arduino Mag - Arduino Projects</title>
		<meta charset="utf-8" />
						...
						<!-- Nav -->
							<nav id="nav">
								<ul>
									...
									<li class="current"><a href="arduino-projects.php">Projects</a></li>
					...
					<div id="banner" class="box container" style="background-image:url('https://images.pexels.com/photos/163100/circuit-circuit-board-resistor-computer-163100.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940')">
						<div class="row">
							<div class="col-12 col-12-medium">
								<h2 style="color:#fff;text-align:center;">Arduino Projects</h2>
							</div>
						</div>
					</div>
				</div>
				...
				<div id="features-wrapper">
					<div class="container" id="articles">
						...
						<?php
									...
									$articlesor = $conn->prepare("SELECT * FROM articles WHERE category = 'project'");
									$articlesor->execute();
